...
gcc -Wall -fpic -shared -o shim_v3.so shim_v3_ssl_ctx_set_verify_short.c common.c -ldl -lssl
gcc -Wall -fpic -shared -o shim_v4.so shim_v4_ssl_get_error.c common.c -ldl -lssl
